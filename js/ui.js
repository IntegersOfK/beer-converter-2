...
import { $, $$, fmt, escapeHtml, vibe } from './util.js?v=17';
import { ethanolOf, personStats, STD_DRINK_ML, ML_PER_OZ } from './calc.js?v=17';
import {
  state, getBenchmark,
...
import { submitProduct } from './submit.js?v=17';
